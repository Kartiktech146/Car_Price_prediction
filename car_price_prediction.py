...
def main():
    ...
    p1 = st.number_input("please enter x-showroom price(In Lakhs)", 2.5,25.0,step = 1.0)
    ...
    if s1 == 'Petrol':
        ...
        p3 = 2    
    s2 = st.selectbox("Enter the seller type",("Dealer","Individual")) 
    if s2 == 'Dealer':
        p4 = 0
    elif s2 == 'Individual':
        p4 = 1
    ...
    years = st.number_input("Car purchased yearr",1990,date_time.year,step =1)
